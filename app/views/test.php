...
<body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item" href="../controllers/AuthController.php?action=logout">Đăng
                                        xuất</a></li>
                            </ul>
                        </li>
                        <?php else: ?>
    ...
    <div class="social-login">
        <!-- Google Sign-In -->
        <div id="g_id_onload" data-client_id="16769569373-33ss6o0l2c3s75urp2trlq4nbahdvapf.apps.googleusercontent.com"
...
function handleCredentialResponse(response) {
    fetch("/auth/google", {
        ...
        .then(data => {
            if (data.success) {
                window.location.href = "/index"; // hoặc route bạn muốn
            } else {
